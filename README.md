...
> TMDB에서 제공하는 open API와 React를 사용해 제작한 영화 소개및 검색 웹앱입니다.<br> 반응형으로 구현하였고 상태관리는 Redux를 사용하였습니다, <br>좋아요 리스트는 로컬스토리지를 사용해 구현하였습니다.
...
### 프로젝트를 통해 배운점.
- 로컬스토리지를 사용한 데이터 저장법.
- styled-components를 사용한 반응형 웹 제작 방법.
- redux를 사용한 상태관리및 데이터 관리.
- 다이나믹 라우터를 이용한 디테일페이지 구현.
